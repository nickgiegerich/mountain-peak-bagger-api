"""
Django settings for peak_bagger project.
...
from .secrets import DJANGO_SECRET_KEY, DEBUG, ALLOWED_HOSTS
...
WSGI_APPLICATION = 'peak_bagger.wsgi.application'
